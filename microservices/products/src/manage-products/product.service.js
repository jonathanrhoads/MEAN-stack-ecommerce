...
class ProductService {
    ...
    async createProduct({ name, price, description }) {
        try {
            ...
            const { insertId } = await this.databaseService.query(productQueries.INSERT_PRODUCT, [name, price, description]);
    ...
    async updateProduct({ name, price, description }, productId) {
        try {
            // Insert into Products
            const { updateId } = await this.databaseService.query(productQueries.UPDATE_PRODUCT, [name, price, description, productId]);
    ...
    async deleteProduct(productId) {
        try {
            // Insert into Products
            const { deleteId } = await this.databaseService.query(productQueries.DELETE_PRODUCT, [productId]);
